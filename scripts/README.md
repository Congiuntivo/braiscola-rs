...
- `export_wiki.sh <output-dir> [api-docs-dir]`
  - Exports wiki-ready markdown pages from repository docs.
  - If `api-docs-dir` is provided, includes generated Rust API markdown pages.
...
bash scripts/export_wiki.sh /tmp/braiscola-wiki-src /tmp/generated-api-md
```
